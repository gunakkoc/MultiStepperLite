...
// MAX_MOTOR_COUNT (default 6) is the maximum number of motors
// total footprint ~= [17 (up to 37) bytes x motor count] + ~16bytes
// decrease to reduce preallocated memory, or use SingleStepperLite for each motor
